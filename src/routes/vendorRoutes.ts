...
import {vendorcreatesFood,vendorLogin, vendorGetsProfile,
    ...
    verifyVendor, registerVendor, vendorGetsOrderCount, vendorTotalRevenue, vendorAvailability, singleOrderDetails,getVendorIncome, editVendorCoverImage, editFoodImage, DeleteAllFood, DeleteSingleFood, changeStatus, updateFood, vendorGetHisPopularFoods } from "../controllers/vendorControllers";
