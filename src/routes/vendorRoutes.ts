...
import {vendorcreatesFood,vendorLogin, vendorGetsProfile,
    ...
    verifyVendor, registerVendor, vendorGetsOrderCount, vendorTotalRevenue, vendorAvailability, singleOrderDetails,getVendorIncome, editVendorCoverImage, editFoodImage, DeleteAllFood, DeleteSingleFood, changeStatus, updateFood } from "../controllers/vendorControllers";
...
router.put('/:foodID/ready',  changeStatus )
...
router.delete('/:foodid/ready', DeleteSingleFood)
