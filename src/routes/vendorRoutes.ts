...
import {vendorcreatesFood,vendorLogin, vendorGetsProfile,
    ...
    verifyVendor, registerVendor, vendorGetsOrders, vendorTotalRevenue, vendorAvailability, singleOrderDetails } from "../controllers/vendorControllers";
...
router.get('/vendorgetorders', vendorauth, vendorGetsOrders)
